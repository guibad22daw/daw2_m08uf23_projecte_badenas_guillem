    ...
    <div class="form input-group">
        ...
        <form action="modificar_usuari.php" method="POST" class="row g-7">
            <div class="col-12">
                ...
                <label for="uid">UID: </label> <input type="text" class="form-control" id="uid" name="uid"
                    placeholder="usuari" required>
                <label for="unorg">Unitat Organitzativa: </label> <input type="text" class="form-control"
                    placeholder="exemples" id="unorg" name="unorg" required>
            </div>
            ...
            <div class="col-12">
                ...
                <input type="text" id="nou_contingut" name="nou_contingut" class="form-control"
                    placeholder="Nou contingut..." required>
